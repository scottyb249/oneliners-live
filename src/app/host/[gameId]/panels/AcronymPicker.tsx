...
import { getTimerDuration, VOTING_TIMER_DURATION } from '@/lib/constants'
  ...
  if (showLeaderboard) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <button
          onClick={() => setShowLeaderboard(false)}
          className="w-full rounded-xl border border-white/20 py-3 text-sm font-bold text-white/60 hover:text-white transition-colors"
        >
